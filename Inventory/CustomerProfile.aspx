<%@ Page Title="Customer" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CustomerProfile.aspx.cs" Inherits="Inventory.CustomerProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="formLayout">
        ...
        <br />
        <label>
            <asp:Button ID="btnSave" CssClass="simpleshape1" runat="server" Text="Save" OnClick="btnSave_Click" /></label>
    </div>
